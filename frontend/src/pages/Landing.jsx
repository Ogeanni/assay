    ...
    <div style={{background:'#18181b', minHeight:'100vh', color:'white'}}>
      ...
      <section style={{maxWidth:900, margin:'0 auto', padding:'0 24px 80px'}}>
        <AnimateIn>
          <div style={{background:'rgba(255,255,255,0.04)', border:'1px solid rgba(255,255,255,0.07)', borderRadius:24, overflow:'hidden', boxShadow:'0 0 0 1px rgba(124,58,237,0.15), 0 40px 80px rgba(0,0,0,0.5), inset 0 1px 0 rgba(255,255,255,0.06)'}}>
            <div style={{padding:'36px 40px 28px', background:'linear-gradient(135deg, rgba(124,58,237,0.1) 0%, rgba(245,158,11,0.05) 100%)', borderBottom:'1px solid rgba(255,255,255,0.06)'}}>
      ...
      <section style={{background:'rgba(255,255,255,0.03)', borderTop:'1px solid rgba(255,255,255,0.06)', borderBottom:'1px solid rgba(255,255,255,0.06)', padding:'100px 0'}}>
        <div style={{maxWidth:1100, margin:'0 auto', padding:'0 24px'}}>
          <AnimateIn>
            <p style={{fontFamily:'JetBrains Mono,monospace', fontSize:11, color:'#a78bfa', letterSpacing:'0.1em', marginBottom:16}}>THE RUBRIC</p>
            <h2 style={{fontFamily:'Bricolage Grotesque,sans-serif', fontWeight:800, fontSize:'clamp(28px,3.5vw,44px)', color:'white', marginBottom:16, lineHeight:1.1}}>
