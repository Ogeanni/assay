...
function AnimatedScore() {
  ...
  return (
    <div ref={ref} className="flex items-end gap-2">
      <span style={{fontFamily:'Bricolage Grotesque,sans-serif', fontSize:72, fontWeight:800, color:'#a78bfa', lineHeight:1, fontVariantNumeric:'tabular-nums'}}>
        {count}
      </span>
      <span style={{fontFamily:'JetBrains Mono,monospace', fontSize:22, color:'rgba(196,181,253,0.7)', marginBottom:8}}>/100</span>
    </div>
  )
}
  ...
  return (
    <div style={{background:'#18181b', minHeight:'100vh', color:'white'}}>
      ...
      <section style={{maxWidth:1100, margin:'0 auto', padding:'100px 24px', position:'relative'}}>
        <AnimateIn>
          <p style={{fontFamily:'JetBrains Mono,monospace', fontSize:11, color:'#7c3aed', letterSpacing:'0.1em', marginBottom:16}}>HOW IT WORKS</p>
          ...
          {[
            ...
            <AnimateIn key={item.n} delay={i * 0.1}>
              ...
              >
                ...
                <p style={{fontFamily:'JetBrains Mono,monospace', fontSize:11, color:'rgba(167,139,250,0.9)', marginBottom:12}}>{item.n}</p>
      ...
      <section style={{background:'rgba(255,255,255,0.03)', borderTop:'1px solid rgba(255,255,255,0.06)', borderBottom:'1px solid rgba(255,255,255,0.06)', padding:'100px 0'}}>
        <div style={{maxWidth:1100, margin:'0 auto', padding:'0 24px'}}>
          <AnimateIn>
            <p style={{fontFamily:'JetBrains Mono,monospace', fontSize:11, color:'#7c3aed', letterSpacing:'0.1em', marginBottom:16}}>THE RUBRIC</p>
            <h2 style={{fontFamily:'Bricolage Grotesque,sans-serif', fontWeight:800, fontSize:'clamp(28px,3.5vw,44px)', color:'white', marginBottom:16, lineHeight:1.1}}>
              ...
              <AnimateIn key={item.name} delay={i * 0.08}>
                ...
                >
                  ...
                  <div style={{borderRadius:12, overflow:'hidden', border:'1px solid rgba(255,255,255,0.06)'}}>
                    ...
                    <div style={{display:'flex', gap:10, padding:'10px 14px', background:'rgba(124,58,237,0.08)'}}>
